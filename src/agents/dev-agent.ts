...
import { getSupportedExtensions } from "../parsers/language-configs.js";
...
// Get all supported extensions from language-configs (38 extensions)
const SUPPORTED_CODE_EXTENSIONS = getSupportedExtensions().map(ext => `.${ext}`);
